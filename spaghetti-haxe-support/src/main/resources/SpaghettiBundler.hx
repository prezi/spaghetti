class SpaghettiBundler
{
	static public function main()
	{
		...
		var contents = '/* Generated by Spaghetti */ require.config({paths:{${modulePaths.join(",")}}}); ${call}([ ${moduleNames.join(",")} ], function() { var __config = { "__modules": { ${modules.join(",")} } }; var __haxeModule; ${haxe}
return __haxeModule;
});
';
