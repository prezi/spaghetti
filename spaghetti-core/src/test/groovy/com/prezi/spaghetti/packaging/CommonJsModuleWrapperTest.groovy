...
class CommonJsModuleWrapperTest extends WrapperTestBase {
	def "CommonJS module"() {
		...
		def result = new CommonJsModuleWrapper().wrap(mockParams("com.example.test", "1.0", ["com.example.alma", "com.example.bela"], ["com.lazy.first"], externalDependencies, originalScript))
		...
		result == [
				';(function(){',
					...
					'module.exports=(function(){',
						...
						'};',
					'})(require("jquery"),require("react"),require("com.example.alma"),require("com.example.bela"),function(){return Promise.resolve(require("com.lazy.first").lazyModule);});',
				'})();'
		].join("")
	}
