 ...
 */
class Wrapper {
	public static String wrap(Collection<String> dependentModuleNames, Wrapping wrapping, String contents) {
		def wrapped
		switch (wrapping) {
	...
	public static String wrapWithConfig(Collection<String> dependentModuleNames, Wrapping wrapping, String modulesRoot, String contents) {
		String configured
		switch (wrapping) {
			case Wrapping.application:
