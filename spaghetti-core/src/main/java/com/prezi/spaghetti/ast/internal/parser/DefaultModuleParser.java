...
public class DefaultModuleParser extends ModuleParser {
	...
	public DefaultModuleParser(Locator locator, com.prezi.spaghetti.internal.grammar.ModuleParser.ModuleDefinitionContext moduleCtx) {
