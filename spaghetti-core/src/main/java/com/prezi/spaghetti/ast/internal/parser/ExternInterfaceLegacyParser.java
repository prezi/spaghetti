...
public class ExternInterfaceLegacyParser extends AbstractModuleTypeParser<ModuleParser.ExternInterfaceDefinitionLegacyContext, DefaultExternInterfaceNode> {
	public ExternInterfaceLegacyParser(Locator locator, ModuleParser.ExternInterfaceDefinitionLegacyContext context) {
		super(locator, context, createNode(locator, context));
	}

	private static DefaultExternInterfaceNode createNode(Locator locator, ModuleParser.ExternInterfaceDefinitionLegacyContext context) {
