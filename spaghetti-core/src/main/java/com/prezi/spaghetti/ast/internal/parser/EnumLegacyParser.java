...
public class EnumLegacyParser extends AbstractModuleTypeParser<ModuleParser.EnumDefinitionLegacyContext, DefaultEnumNode> {
	...
	public EnumLegacyParser(Locator locator, ModuleParser.EnumDefinitionLegacyContext context, String moduleName) {
		super(locator, context, createNode(locator, context, moduleName));
	}

	private static DefaultEnumNode createNode(Locator locator, ModuleParser.EnumDefinitionLegacyContext context, String moduleName) {
		DefaultEnumNode node = new DefaultEnumNode(locator.locate(context.Name()), DefaultFQName.fromString(moduleName, context.Name().getText()));
